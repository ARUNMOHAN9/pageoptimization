...
var makeRandomPizza = function() {
  ...
  for (var i = 0; i < numberOfMeats; i++) {
    pizza = pizza + "<li>" + (selectRandomMeat()) + "</li>";
  }

  for (var j = 0; j < numberOfNonMeats; j++) {
    pizza = pizza + "<li>" + (selectRandomNonMeat()) + "</li>";
  }

  for (var k = 0; k < numberOfCheeses; k++) {
    pizza = pizza + "<li>" + (selectRandomCheese()) + "</li>";
  }

  pizza = pizza + "<li>" + (selectRandomSauce()) + "</li>";
  pizza = pizza + "<li>" + (selectRandomCrust()) + "</li>";
...
function updatePositions() {
  ...
  for (var i = 0, len = items.length, phase; i < len; i++) {
    phase = 100*Math.sin( scrollCalc + (i % 5));
